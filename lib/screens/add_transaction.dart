          ...
          children: [
            ...
            PopupMenuButton(
              child: Column(
                  ...
                  children: [
                    Text(
                      widget.user.people[_selectedP].name,
                      style: TextStyle(
                          color: Colors.blueGrey[700],
                          fontWeight: FontWeight.bold,
                          fontSize: 18),
                    ...
                    Text(
                      widget.user.people[_selectedP].address,
                      style: TextStyle(
            ...
            GestureDetector(
                ...
                child: Text(
                  '${date.substring(8, 10)} ${months[int.parse(date.substring(5, 7)) - 1]}, ${date.substring(0, 4)}',
                  style: TextStyle(
                      color: Colors.blueGrey[700],
                      fontWeight: FontWeight.bold,
                      fontSize: 18),
            ...
            Center(
              child: GestureDetector(
                onTap: () {
                  widget.user.addTransaction(
                      _amount,
                      widget.user.people[_selectedP].name,
                      widget.user.people[_selectedP].id,
                      _isCredit,
                      _dateTime,
                      _note,
                      _selectedMethod,
                      isInterest: _isForInterest);
